    ...
    >
      ...
      <Command.List className="max-h-[60vh] overflow-y-auto px-2 py-2">
        ...
        <Group heading="Quick actions">
          <PaletteItem icon={Plus} label="Start new chat" onSelect={() => go(ROUTES.CHAT)} shortcut="⌘N" />        </Group>
        ...
        <Group heading="Navigate">
          ...
          />
          <PaletteItem icon={MessageSquare} label="Chat" onSelect={() => go(ROUTES.CHAT)} />          <PaletteItem icon={UserCircle} label="Profile" onSelect={() => go(ROUTES.PROFILE)} />
