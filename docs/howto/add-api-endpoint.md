...
```python
# app/db/models/notification.pyfrom uuid import uuid4
...
from uuid import UUIDfrom sqlalchemy import select
...
class NotificationService:    def __init__(self, db: AsyncSession):
        self.db = db
...
from app.schemas.notification import NotificationCreate, NotificationResponsefrom app.api.deps import CurrentUser
router = APIRouter()
...
async def create_notification(
    ...
    service: NotificationSvc,    current_user: CurrentUser,):
