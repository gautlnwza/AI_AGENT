...
branch_labels = None
depends_on = Nonedef _id_col() -> sa.Column:
    return sa.Column(
        "id",
...
def downgrade() -> None:    op.drop_table("message_ratings")
    op.drop_table("conversation_shares")    op.drop_table("chat_files")
