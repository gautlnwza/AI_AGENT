"""Exception handler tests."""# ruff: noqa: I001, E402 - Imports structured for Jinja2 template conditionals
import pytest
...
from unittest.mock import AsyncMock, MagicMockServiceMock = AsyncMock
from httpx import ASGITransportfrom app.api.deps import get_redisfrom app.api.deps import get_db_sessionfrom app.main import app
...
async def error_client(
    mock_user_service_with_errors: MagicMock,    mock_redis: MagicMock,    mock_db_session,) -> AsyncClient:
    """Client with mocked services that raise errors."""
    from app.api.deps import get_user_service

    app.dependency_overrides[get_user_service] = lambda: mock_user_service_with_errors    app.dependency_overrides[get_redis] = lambda: mock_redis    app.dependency_overrides[get_db_session] = lambda: mock_db_session
